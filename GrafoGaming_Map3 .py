...
print("")
print("la ruta lateral izquierda : ordinaria & Segura", G.get_connections("LI"))
print("")
print("la ruta Central : ordinaria y ¡Peligrosa!, + Movilidad",G.get_connections("C"))
print("")
print("la ruta lateral Derecha : ordinaria, Segura - Rango", G.get_connections("LD"))
print("")
